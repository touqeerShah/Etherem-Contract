...
module.exports = async ({ getNamedAccounts, deployments, getChainId }) => {
  ...
  log(
    `Your contract is deployed on local network to ${TKSVGToken.address} ${chainId}`
  );
  ...
  log(
    `verifty   with npx hardhat verify --network ${networkName} ${svgNFT.address} `
  );
